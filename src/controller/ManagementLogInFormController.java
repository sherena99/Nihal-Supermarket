...
public class ManagementLogInFormController {
    ...
    public void logInButtonOnAction(ActionEvent actionEvent) throws IOException, SQLException, ClassNotFoundException {
        ...
        if(!rst.next()){
            ...
            Parent parent = FXMLLoader.load(this.getClass().getResource("../viewManagement/ManagementDashBoardForm.fxml"));
            Scene scene = new Scene(parent);
            Stage primaryStage = (Stage) this.managementLogInContext.getScene().getWindow();
