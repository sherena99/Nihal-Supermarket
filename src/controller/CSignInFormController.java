...
public class CSignInFormController {
    public AnchorPane CSignInContext;
    ...
    public void RegisterButtonOnAction(ActionEvent actionEvent) throws SQLException, ClassNotFoundException {
        ...
        String query = "INSERT INTO UserCashier VALUES(?,?)";
    ...
    public void cancelButtonOnAction(ActionEvent actionEvent) throws IOException {
        ...
        Stage window = (Stage) CSignInContext.getScene().getWindow();
